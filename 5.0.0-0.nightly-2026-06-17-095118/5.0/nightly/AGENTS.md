# Payload Snapshot: 5.0.0-0.nightly-2026-06-17-095118
...
- **Target payload**: `5.0.0-0.nightly-2026-06-17-095118`
- **Phase**: Rejected
- **Blocking jobs**: 4/14 failed
- **Informing jobs**: 43/75 failed
- **Chain depth**: 8 payloads back to baseline
- **Baseline**: `5.0.0-0.nightly-2026-06-14-105938` (70.9h ago)

### Payload chain (newest first)

  - 5.0.0-0.nightly-2026-06-17-095118
  - 5.0.0-0.nightly-2026-06-17-022519
  - 5.0.0-0.nightly-2026-06-16-185706
  - 5.0.0-0.nightly-2026-06-16-123929
  - 5.0.0-0.nightly-2026-06-16-065742
  - 5.0.0-0.nightly-2026-06-16-003434
  - 5.0.0-0.nightly-2026-06-14-221055
  - 5.0.0-0.nightly-2026-06-14-105938

### Failed blocking jobs

  - `aggregated-aws-ovn-single-node-upgrade-5.0-micro`
  - `aggregated-azure-ovn-upgrade-5.0-micro`
  - `metal-ipi-ovn-ipv4`
  - `metal-ipi-ovn-ipv6`
...
5.0/nightly/
  ...
  5.0.0-0.nightly-2026-06-17-095118/                    # Target payload
