# Payload Snapshot: 4.20.0-0.nightly-2026-05-13-064706

OpenShift 4.20 nightly (amd64) — **Accepted**
...
- **Target payload**: `4.20.0-0.nightly-2026-05-13-064706`
- **Phase**: Accepted
- **Blocking jobs**: 1/13 failed
- **Informing jobs**: 0/0 failed
- **Chain depth**: 2 payloads back to baseline
- **Baseline**: `4.20.0-0.nightly-2026-05-11-024741` (52.0h ago)

### Payload chain (newest first)

  - 4.20.0-0.nightly-2026-05-13-064706
...
4.20/nightly/
  ...
  4.20.0-0.nightly-2026-05-13-064706/                    # Target payload
