# Payload Snapshot: 5.0.0-0.ci-2026-04-14-085906
...
- **Target payload**: `5.0.0-0.ci-2026-04-14-085906`
- **Phase**: Rejected
- **Blocking jobs**: 1/5 failed
- **Informing jobs**: 0/0 failed
- **Chain depth**: 2 payloads back to baseline
- **Baseline**: `5.0.0-0.ci-2026-04-13-145904` (18.0h ago)

### Payload chain (newest first)

  - 5.0.0-0.ci-2026-04-14-085906
  - 5.0.0-0.ci-2026-04-13-145904
...
5.0/ci/
  ...
  5.0.0-0.ci-2026-04-14-085906/                    # Target payload
