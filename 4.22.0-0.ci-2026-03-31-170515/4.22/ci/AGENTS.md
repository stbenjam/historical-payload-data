# Payload Snapshot: 4.22.0-0.ci-2026-03-31-170515

OpenShift 4.22 ci (amd64) — **Rejected**
...
- **Target payload**: `4.22.0-0.ci-2026-03-31-170515`
- **Phase**: Rejected
- **Blocking jobs**: 2/5 failed
- **Informing jobs**: 0/0 failed
- **Chain depth**: 3 payloads back to baseline
- **Baseline**: `4.22.0-0.ci-2026-03-29-160521` (49.0h ago)

### Payload chain (newest first)

  - 4.22.0-0.ci-2026-03-31-170515
  - 4.22.0-0.ci-2026-03-30-040521
  - 4.22.0-0.ci-2026-03-29-160521
...
4.22/ci/
  ...
  4.22.0-0.ci-2026-03-31-170515/                    # Target payload
